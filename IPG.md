...
در تمامی ارتباطات بین وب‌سایت پذیرنده و وب‌سرویس دماوند، IP سرور پذیرنده بررسی می‌شود و اگر با IP داده شده به شرکت در زمان ثبت درخواست متفاوت باشد، پذیرنده در پاسخ از وب‌سرویس خطا دریافت می‌کند.
...
| ```BuyID``` | ```String``` | شناسه خرید - این مقدار به اختیار پذیرنده تنظیم می‌شود (حداکثر 20 کاراکتر که می‌تواند شامل اعداد و حروف انگلیسی باشد) ‌ |
